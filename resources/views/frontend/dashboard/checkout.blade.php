                            ...
                            <article id="post-8" class="post-8 page type-page status-publish hentry">
                                ...
                                <div class="entry-content">
                                    <div class="woocommerce">
                                        ...
                                        <form name="checkout" method="POST" class="checkout woocommerce-checkout row" action="{{ route('orders')}}" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('POST') }}
                                            <div class="col-md-7">
                                                <div class="row">
                                                    ...
                                                    <table class="shop_table woocommerce-checkout-review-order-table">
                                                        ...
                                                        <tbody>
                                                            <tr class="cart-subtotal">
                                                                <th>Subtotal</th>
                                                                <td><strong class="sub-total">$ <span class="price"></span></strong></td>
                                                            </tr>
                                                            <tr class="cart_item">
                                                        ...
                                                        <tr class="order-total">
                                                            <th>Total</th>
                                                            <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">$ </span></span></strong> </td>
                                                        </tr>
                                                        </tfoot>
                                                    </table>
