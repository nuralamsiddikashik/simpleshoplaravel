...
<!--hero section start-->
<div id="home">
    <section class="hero js_full_height base-gradient- " style="background-image: url('{{asset('frontend')}}/assets/img/hero.jpg');">
...
<main class="site-main">
                ...
                <div class="col-md-12">
                    <ul class="products columns-3">
                        <li class="product-category product first  ">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc1.jpg" alt="Clothing">
                        ...
                        <li class="product-category product">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc2.jpg" alt="Decor">
                                <h2 class="woocommerce-loop-category__title">
                                    Decor
                        ...
                        <li class="product-category product last">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc3.jpg" alt="Music">
                                <h2 class="woocommerce-loop-category__title">
                                    Music
                        ...
                        <li class="product-category product">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc4.jpg" alt="Clothing">
                                <h2 class="woocommerce-loop-category__title">
                                    Clothing
                                    <!--<mark class="count">(14)</mark>-->
                                </h2>
                        ...
                        <li class="product-category product">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc5.jpg" alt="Decor">
                                <h2 class="woocommerce-loop-category__title">
                                    Decor
                                    <!--<mark class="count">(1)</mark>-->
                                </h2>
                        ...
                        <li class="product-category product last">
                            <a href="#">
                                <img src="{{asset('frontend')}}/assets/img/pc1.jpg" alt="Music">
                                <h2 class="woocommerce-loop-category__title">
                                    Music
                                    <!--<mark class="count">(2)</mark>-->
                                </h2>
                    ...
                    <ul class="products columns-3">
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p1.jpg" alt="">
                                </a>
                        ...
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p2.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product last">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p3.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p4.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p5.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product last">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p6.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p8.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product last">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p9.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="promo-box space-3">
                        <div class="promo-img rounded bg-overlay" data-overlay="1" style="background-image: url({{asset('frontend')}}/assets/img/sb.jpg);"></div>
                        <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="products columns-3">
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p10.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p11.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
                        ...
                        <li class="product last">
                            <div class="product-wrap">
                                <a href="#" class="">
                                    <img src="{{asset('frontend')}}/assets/img/p12.jpg" alt="">
                                </a>
                                <a href="#" class="button product_type_simple add_to_cart_button ajax_add_to_cart">
                                    <i class="fa fa-shopping-basket"></i>
                                </a>
    ...
    <section class="">
        ...
        <div class="flickr-list">
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/s1.jpg')"></a>
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/sb.jpg')"></a>
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/s2.jpg')"></a>
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/s3.jpg')"></a>
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/s4.jpg')"></a>
            <a href="#" style="background-image: url('{{asset('frontend')}}/assets/img/s5.jpg')"></a>
        </div>
    </section>
    <!-- flickr section end-->
</main>
